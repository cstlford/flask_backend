...
def chat():
    ...
    response_data = {
        ...
        "User Food Preferences": user_meal_plan_preference.food_preferences or "No food Preferences Set",
        "User Food Restrictions": user_meal_plan_preference.food_avoidances or "No food restrictions set",
